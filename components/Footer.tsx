          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex items-center gap-4 mt-6">
              <a 
                ...
                className="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-br from-accent-500 to-accent-600 rounded-lg hover:shadow-lg hover:scale-110 transition-all duration-200"
