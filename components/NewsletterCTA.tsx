        ...
        >
          ...
          >
            ...
            <input
              ...
              className="flex-1 px-6 py-4 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-white quantum-layer depth-shadow-1 disabled:opacity-50 disabled:cursor-not-allowed"
              required
              aria-required="true"
            ...
            <button
              type="submit"
              className="px-8 py-4 bg-white text-primary-600 font-semibold rounded-lg btn-3d quantum-glow depth-shadow-2 whitespace-nowrap disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
